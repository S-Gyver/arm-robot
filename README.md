...
| :--- | :--- | :--- | :--- |
| **Base** | ส้ม/เหลือง | **GPIO 16** | ฐานหมุนซ้าย-ขวา |
| **Shoulder** | ส้ม/เหลือง | **GPIO 17** | ยกแขนขึ้น-ลง |
| **Elbow** | ส้ม/เหลือง | **GPIO 18** | พับข้อศอก |
| **Gripper** | ส้ม/เหลือง | **GPIO 19** (หรือ GPIO 22 ใน 6-Servo) | อ้า-หุบก้ามปู |
