# 🤖 4-Axis Robot Arm Controller (Classroom IoT Edition)

ระบบเว็บแอปพลิเคชันสำหรับควบคุมแขนกล 4 ข้อต่อ (4-Axis Robot Arm) ระยะไกลผ่านสมาร์ตโฟน ออกแบบมาสำหรับการเรียนการสอนในห้องเรียน รองรับหลายกลุ่ม/หลายโต๊ะพร้อมกัน (Multi-Classroom / Multiple Robots)
